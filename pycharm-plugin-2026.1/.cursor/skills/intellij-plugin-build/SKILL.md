...
# IntelliJ plugin build (2026.1.x line)
...
| 2026.1.x | `/Users/oleksii/Work/pycharm-plugin/pycharm-plugin-2026.1` (this folder) | `pycharm("2026.1.2")`, `platformVersion=2026.1.2` | `.intellijPlatform/sandbox/vertex-workbench-pycharm/PY-2026.1.2/log/idea.log` |
