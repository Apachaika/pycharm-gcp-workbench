...
**Version / platform (this line):** plugin `0.3.39`, PyCharm `2026.1.2`, `sinceBuild=261`, Java 17, Gradle 9.

**Two build lines:** 2025.3.x at `/Users/oleksii/Work/pycharm-plugin` and 2026.1.x in this folder. Behavior changes must land in both. See [dual-version-maintenance](../dual-version-maintenance/SKILL.md).
